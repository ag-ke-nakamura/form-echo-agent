...
import { selectedCandidates } from "@/features/meeting/candidates/candidate-calendar";
import { CandidatesPanel } from "@/features/meeting/candidates/candidates-panel";
import { useCandidateCalendar } from "@/features/meeting/candidates/use-candidate-calendar";
import { useMeetingInfo } from "@/features/meeting/shared/meeting-info-fields";
...
export function FormEchoTabs() {
   ...
   * 置き場所だけ — 状態モデルの定義は `meeting-info-fields.tsx` に残す。
   */
   ...
   * 状態モデルは `features/meeting/candidates/candidate-calendar.ts` にあり、ここに上がったのは
  ...
  const panels: Record<TabId, ReactNode> = {
    ...
    /*
      ...
      モックの表が持つべきものではない（`features/meeting/recommend/availability-table.ts`）。
