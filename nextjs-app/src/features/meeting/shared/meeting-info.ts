import type { AiEvaluationLabel } from "@/lib/contracts/recommendation";
import type { Availability, MeetingFormat } from "@/lib/contracts/meeting";
import { DURATION_OPTIONS } from "@/lib/contracts/meeting";
 ...
 *
 * **値域そのものは `@/lib/contracts/meeting.ts` にある**（#67 / ADR-0005）。参加形式と
