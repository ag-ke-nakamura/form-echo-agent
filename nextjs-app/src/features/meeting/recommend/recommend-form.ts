...
import { initialSelection } from "@/lib/contracts/recommendation";
import type { RecommendScheduleInput } from "@/lib/contracts/types";
import { candidateRangeText, type MeetingInfo } from "../shared/meeting-info";
 ...
 *
 * 評点からラベル・初期選択を導くのは契約側（`@/lib/contracts/recommendation.ts`）で、ここが
